...
class _OnBoardingScreenState extends State<OnBoarding> {
  ...
  void onIntroEnd() {
    setOnBoardDataAfterScreenCompleted();
  }
                ...
                child: PageView(
                  ...
                  children: [
                    buildSlider(
                        title: "Welcome",
                        content:
                            "The NewRoads automotive group have always followed our goal of achieving a level of customer satisfaction above any expectations",
                        image: "on_board_one"),
                    buildSlider(
                        title: "Get the relaxed feeling!",
                        content:
                            "Stepping away from something stressful for a few minutes or taking time away from your normal routines and thoughts",
                        image: "on_board_two"),
                    buildSlider(
                        title: "Life is a journey. Enjoy the ride with a taxi",
                        content:
                            "Sometimes the longest journey we make is the sixteen inches from our heads to our hearts",
                        image: "on_board_three"),
                  ],
                ),
              ),
              SizedBox(
